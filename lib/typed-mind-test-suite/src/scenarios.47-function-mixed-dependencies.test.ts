...
`;
    ...
    assert.equal(
      errorMessages.some((m) => m.includes("'UndefinedUI' not found")),
      true,
    );
    assert.equal(
      errorMessages.some((m) => m.includes("'MissingAsset' not found")),
      true,
    );
    assert.equal(
      errorMessages.some((m) => m.includes("'NonExistentDTO' not found")),
      true,
    );
    assert.equal(
      errorMessages.some((m) => m.includes("'unknownFunction' not found")),
      true,
    );
    assert.equal(
      errorMessages.some((m) => m.includes("'missingDep' not found")),
      true,
    );
    assert.equal(
      errorMessages.some((m) => m.includes("'NoSuchConfig' not found")),
      true,
    );
