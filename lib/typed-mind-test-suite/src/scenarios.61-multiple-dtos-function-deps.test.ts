...
describe('Scenario 61: Multiple DTOs in function dependencies', () => {
  ...
  it('should auto-assign single DTO to input', () => {
    ...
    const simpleTransform = Array.from(parseResult.entities.values()).find((e) => e.name === 'simpleTransform' && e.type === 'Function');
  ...
  it('should handle multiple DTOs in dependencies', () => {
    ...
    const complexTransform = Array.from(parseResult.entities.values()).find((e) => e.name === 'complexTransform' && e.type === 'Function');
  ...
  it('should handle explicit input/output with additional DTOs', () => {
    ...
    const explicitFunction = Array.from(parseResult.entities.values()).find((e) => e.name === 'explicitFunction' && e.type === 'Function');
  ...
  it('should handle multiple potential input DTOs', () => {
    ...
    const ambiguousFunction = Array.from(parseResult.entities.values()).find(
      (e) => e.name === 'ambiguousFunction' && e.type === 'Function',
    );
  ...
  it('should handle DTO as both input and output', () => {
    ...
    const selfTransform = Array.from(parseResult.entities.values()).find((e) => e.name === 'selfTransform' && e.type === 'Function');
  ...
  it('should auto-distribute mixed dependencies', () => {
    ...
    const mixedDependencies = Array.from(parseResult.entities.values()).find(
      (e) => e.name === 'mixedDependencies' && e.type === 'Function',
    );
  ...
  it('should handle functions with only DTO dependencies', () => {
    ...
    const pureDataFunction = Array.from(parseResult.entities.values()).find((e) => e.name === 'pureDataFunction' && e.type === 'Function');
  ...
  it('should handle nested DTO references', () => {
    ...
    const nestedInput = Array.from(parseResult.entities.values()).find((e) => e.name === 'NestedInput' && e.type === 'DTO');
    const outerDTO = Array.from(parseResult.entities.values()).find((e) => e.name === 'OuterDTO' && e.type === 'DTO');
    const middleDTO = Array.from(parseResult.entities.values()).find((e) => e.name === 'MiddleDTO' && e.type === 'DTO');
    const _innerDTO = Array.from(parseResult.entities.values()).find((e) => e.name === 'InnerDTO' && e.type === 'DTO');
    ...
    const nestedFunction = Array.from(parseResult.entities.values()).find((e) => e.name === 'nestedFunction' && e.type === 'Function');
  ...
  it('should handle DTO arrays and optional fields', () => {
    ...
    const arrayInput = Array.from(parseResult.entities.values()).find((e) => e.name === 'ArrayInput' && e.type === 'DTO');
    ...
    const arrayFunction = Array.from(parseResult.entities.values()).find((e) => e.name === 'arrayFunction' && e.type === 'Function');
  ...
  it('should validate all DTOs are properly defined', () => {
    ...
    const errors = validationResult.errors.filter((e) => e.message.includes('undefined') && e.message.includes('type'));
  ...
  it('should export all functions properly', () => {
    ...
    const processorFile = Array.from(parseResult.entities.values()).find((e) => e.name === 'ProcessorFile' && e.type === 'File');
    ...
    const orphanedFunctions = validationResult.errors.filter((e) => e.message.includes('Function') && e.message.includes('not exported'));
