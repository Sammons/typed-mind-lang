// RFC-TM-16 (rfc-tm-16-diamond.md) — frozen assertion-code registry.
// Every deviations.push() call site in assertion-engine.ts must reference
// a code from this registry. The enforcement test (assertion-codes.test.ts)
// greps emission sites and deep-equals against ASSERTION_CODES.
//
// Shape: const object mapping code → metadata. The doc generator reads
// this at build time to produce the diagnostics reference page. suggestion
// and docBody are required — no placeholders.
...
export const ASSERTION_CODES = {
  ...
  'assertion/entity-missing': {
    ...
    suggestion: 'Add the missing entity to the TypeScript source, or remove it from the TMD.',
    docBody:
      'The TMD declares an entity (file, class, function, DTO, etc.) that the converter ' +
      'did not produce from the TypeScript source. Either the source is missing the ' +
  ...
  'assertion/entity-extra': {
    ...
    docBody:
      'The converter extracted an entity from the TypeScript source that has no ' +
  ...
  'assertion/entity-kind-downgraded': {
    ...
    docBody:
      ...
      'classified it as a DTO (the TypeScript source is a type alias or interface). ' +
  ...
  'assertion/path-mismatch': {
    ...
    docBody:
      ...
      'that does not match the path the converter derived from the TypeScript source. ' +
  ...
  'assertion/extends-mismatch': {
    ...
    docBody:
      ...
      'class) than the converter found in the TypeScript source.',
  },
  ...
  'assertion/field-missing': {
    ...
    docBody:
      ...
      'TypeScript source. Either the field was removed from the source or renamed.',
  },
  'assertion/field-extra': {
    ...
    docBody:
      'The converter found a field in the TypeScript source that the TMD DTO entity ' +
  ...
  'assertion/field-type-mismatch': {
    ...
    docBody:
      'The TMD DTO entity declares a field type that does not match the TypeScript ' +
  ...
  'assertion/field-type-unrepresentable': {
    ...
    docBody:
      'The TMD DTO field type differs from the TypeScript source, but the mismatch ' +
  ...
  'assertion/field-optionality-mismatch': {
    ...
    docBody:
      'The TMD DTO field is marked as optional (or required) but the TypeScript source ' +
  ...
  'assertion/boundary-missing': {
    ...
    docBody:
      ...
      'did not find in the TypeScript source. Entity-level names (names that match other ' +
  ...
  'assertion/boundary-extra': {
    ...
    docBody:
      'The converter found an import or export in the TypeScript source that the TMD ' +
  ...
  'assertion/member-missing': {
    ...
    docBody:
      ...
      'converter did not find in the TypeScript source. This covers the `methods`, ' +
  ...
  'assertion/member-extra': {
    ...
    docBody:
      ...
      'TypeScript source that the TMD entity does not declare. This is a warning ' +
