...
const EXPECTED_A2_MESSAGES = [
  ...
  'Unparsable text: `FileUtils < "File utilities interface"` — check this line against the grammar and fix or remove it', // ProcessUtils's block now folds in too (RFC-TM-8 collateral, see above)
];
