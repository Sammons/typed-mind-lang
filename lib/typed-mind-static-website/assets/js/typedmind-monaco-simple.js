...
function getKeywordHoverInfo(keyword) {
  const keywordInfo = {
    ...
    'suppress': '**suppress** - Suppresses a diagnostic\n\nSilences a named diagnostic code for a specific entity: `suppress orphan-entity MyHelper`.',
...
function getOperatorAtPosition(lineContent, column) {
  const operators = [
    ...
    { pattern: '>>', description: '**>>** - Contains-program operator\n\nDeclares that this program contains another program as a sub-system.' },
