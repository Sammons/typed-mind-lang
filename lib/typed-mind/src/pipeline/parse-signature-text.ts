import type { SignatureParameter, SignatureParseResult, SignatureTypePosition } from '../ast/callable-signature.ts';
...
export type { ParsedSignature, SignatureParameter, SignatureParseResult, SignatureTypePosition } from '../ast/callable-signature.ts';
