...
const NAMED_TOKEN = /^[A-Za-z_]\w*(?:\.[A-Za-z_]\w*)*/;
...
const parseAtom = (cursor: TextCursor, inGenericArgs = false): TypeExprNode => {
  ...
  // One named-type parser owns both bare and qualified names, including
  // qualified generic bases. This mirrors the grammar type_named production.
